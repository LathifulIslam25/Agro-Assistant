...
public class Calculator1 extends AppCompatActivity {
    ...
    private void makeCalculation_N() {
        ...
        if(!(n_inp) & !(p_inp) & !(k_inp) & !(area_inp) & !(amt_inp) & !(err)) {
            ...
            if (sp1.equals("1000 ft^2") && sp2.equals("ft^2")) {
                ...
                T_result = (((lbofN * N_amt) * (areaInput / 1000.0))*0.45);
                P_result = ((T_result / lbofP)*0.45);
                K_result = ((T_result / lbofK)*0.45);
                N_result = ((T_result / lbofN)*0.45);

            } else if (sp1.equals("Acre") && sp2.equals("Acre(s)")) {
                T_result = ((lbofN * N_amt) * (areaInput))*0.45;
                P_result = (T_result / lbofP)*0.45;
                K_result = (T_result / lbofK)*0.45;
                N_result = (T_result / lbofN)*0.45;
                ...
                T_result = ((lbofN * N_amt) * (areaInput * (1.0 / 43560.0)))*0.45;
                P_result = (T_result / lbofP)*0.45;
                K_result = (T_result / lbofK)*0.45;
                N_result = (T_result / lbofN)*0.45;
            ...
            result = "Fertilizer needed: " + df.format(T_result) + " Kg\n   " + "Total N applied: " + df.format(N_result) + " kg\n   This also applies:\n   " +
                    df.format(P_result) + " Kg of P\n   " + df.format(K_result) + " Kg of K.";
    ...
    private void makeCalculation_P(){
        ...
        if(!(n_inp) & !(p_inp) & !(k_inp) & !(area_inp) & !(amt_inp) & !(err)) {
            ...
            if (sp1.equals("1000 ft^2") && sp2.equals("ft^2")) {
                //only if they input per 1000ft2
                T_result = ((lbofP * P_amt) * (areaInput / 1000.0))*0.45;
                N_result = (T_result / lbofN)*0.45;
                K_result = (T_result / lbofK)*0.45;
                P_result = (T_result / lbofP)*0.45;

            } else if (sp1.equals("Acre") && sp2.equals("Acre(s)")) {
                T_result = ((lbofP * P_amt) * (areaInput))*0.45;
                N_result = (T_result / lbofN)*0.45;
                K_result = (T_result / lbofK)*0.45;
                P_result = (T_result / lbofP)*0.45;

            } else if (sp1.equals("1000 ft^2") && sp2.equals("Acre(s)")) {
                T_result = ((lbofP * P_amt) * (areaInput * (43560.0 / 1000.0)))*0.45;
                N_result = (T_result / lbofN)*0.45;
                K_result = (T_result / lbofK)*0.45;
                P_result = (T_result / lbofP)*0.45;

            } else if (sp1.equals("Acre") && sp2.equals("ft^2")) {
                T_result = ((lbofP * P_amt) * (areaInput * (1.0 / 43560.0)))*0.45;
                N_result = (T_result / lbofN)*0.45;
                K_result = (T_result / lbofK)*0.45;
                P_result = (T_result / lbofP)*0.45;
            ...
            result = "Fertilizer needed: " + df.format(T_result) + " Kg\n   " + "Total P applied: " + df.format(P_result) + " Kg\n   This also applies:\n   " +
                    df.format(N_result) + " kg of N\n   " + df.format(K_result) + " Kg of K.";
            tv_result.setMovementMethod(ScrollingMovementMethod.getInstance());
            tv_result.setText(result);
        }else err = true;
        if(err){
    ...
    private void makeCalculation_K() {
        ...
        if (!(n_inp) & !(p_inp) & !(k_inp) & !(area_inp) & !(amt_inp) & !(err)) {
            ...
            if (sp1.equals("1000 ft^2") && sp2.equals("ft^2")) {
                //only if they input per 1000ft2
                T_result = ((lbofK * K_amt) * (areaInput / 1000.0))*0.45;
                P_result = (T_result / lbofP)*0.45;
                N_result = (T_result / lbofN)*0.45;
                K_result = (T_result / lbofK)*0.45;

            } else if (sp1.equals("Acre") && sp2.equals("Acre(s)")) {
                T_result = ((lbofK * K_amt) * (areaInput))*0.45;
                P_result = (T_result / lbofP)*0.45;
                N_result = (T_result / lbofN)*0.45;
                K_result = (T_result / lbofK)*0.45;

            } else if (sp1.equals("1000 ft^2") && sp2.equals("Acre(s)")) {
                T_result = ((lbofK * K_amt) * (areaInput * (43560.0 / 1000.0)))*0.45;
                P_result = (T_result / lbofP)*0.45;
                N_result = (T_result / lbofN)*0.45;
                K_result = (T_result / lbofK)*0.45;

            } else if (sp1.equals("Acre") && sp2.equals("ft^2")) {
                T_result = ((lbofK * K_amt) * (areaInput * (1.0 / 43560.0)))*0.45;
                P_result = (T_result / lbofP)*0.45;
                N_result = (T_result / lbofN)*0.45;
                K_result = (T_result / lbofK)*0.45;
            }

            result = "Fertilizer needed: " + df.format(T_result) + " Kg\n   " + "Total K applied: " + df.format(K_result) + " Kg\n   This also applies:\n   " +
                    df.format(P_result) + " Kg of P\n   " + df.format(N_result) + " Kg of N.";
